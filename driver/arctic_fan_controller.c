...
/*
 * Local change for Ubuntu 24.04 kernel 6.8 (mainline commit e28d0c73d4d7 assumes
 * kernel 6.12+, where asm/unaligned.h was renamed to linux/unaligned.h).
 * Everything else is the mainline file byte for byte.
 */
